                    ...
                    <?php
                        ...
                        foreach( $savings as $dir => $name ){
                                echo '<div class="dropdown-item-double">';
                                    printf( '<button class="did-1" onClick="api.load(\'save/%1$s/sharepic.html\')"><div>%2$s</div><div class="thumb" style="background-image:url(index.php?c=proxy&r=%3$d&p=save/%1$s/thumbnail.png)"></div></button>', $dir, $name, rand() );
                ...
                <div id="my-public-sharepics" class="submenu-content">
                    <?php
                        ...
                        foreach( $templates as $dir ){
                                ...
                                echo '<div class="dropdown-item-double">';
                                    printf( '<button class="did-1" onClick="api.load(\'%1$s/sharepic.html\')"><div>%2$s</div><div class="thumb" style="background-image:url(%1$s/thumbnail.png)"></div></button>', $dir, $name );
