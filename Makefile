...
deploy-develop:
	rsync -avz --delete assets node_modules/quill/dist index.php languages src templates vendor favicon.ico sharepic:/var/www/mint-develop.sharepicgenerator.de

deploy-gruene-develop:
	rsync -avz --delete assets node_modules/quill/dist index.php languages src templates vendor favicon.ico install.php sharepic:/var/www/develop.sharepicgenerator.de/version3
